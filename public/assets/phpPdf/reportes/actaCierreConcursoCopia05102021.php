...
$html='  <header class="clearfix">
      ...
      <div id="project">
        ...
        <div><span>de San Juan, siendo las 12 Horas' .' <strong> '.$extraido10['hora'].' </strong> del dia <strong>'.$fechaCierre. '</strong> se procede a labrar la presente Acta, para registrar  </span></div>
      ...
      <table>
        ...
        <tbody>';
				...
				$html.='<tr>
								...
								<td class="desc">'.$extraido11['expediente'].'</td>
								<td class="unit">'.$extraido11['documento'].'</td>
								<td class="unit">'.$extraido11['folio'].'</td>
          			</tr>';
